...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePassword(password)) {
      return setError("Password must contain uppercase, lowercase, number & symbol and be at least 8 characters");
    }
    ...
    <div className="min-h-screen flex flex-col justify-center bg-gradient-to-br from-[#f8fafc] via-[#f1f5f9] to-[#e2e8f0] px-6 py-12 relative overflow-hidden" style={{ display: "flex", alignItems: "center" }}>
      ...
      <div className="auth-wrapper z-10" style={{ width: "100%", maxWidth: "480px", minHeight: "auto", margin: "100px auto 40px" }}>
        <div className="auth-card" style={{ width: "100%", padding: "2.5rem 3rem", background: "rgba(255, 255, 255, 0.95)", borderRadius: "24px", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.06), 0 0 0 1px rgba(0,0,0,0.02)", backdropFilter: "blur(8px)" }}>
          ...
          <h1 className="text-center" style={{ color: "#064E3B", fontSize: "28px", fontWeight: "800", marginBottom: "0.5rem", textAlign: "center" }}>Reset Password</h1>
          ...
          <form onSubmit={handleSubmit} className="form-stack" style={{ width: "100%", display: "flex", flexDirection: "column", gap: "18px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              <label style={{ fontWeight: "600", color: "#064E3B", fontSize: "14px" }}>New Password</label>
              <input
                type="password"
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              <label style={{ fontWeight: "600", color: "#064E3B", fontSize: "14px" }}>Confirm Password</label>
              <input
                type="password"
            ...
            <button
              ...
              disabled={loading}
              style={{ background: "#064E3B", color: "white", border: "none", height: "48px", borderRadius: "8px", fontWeight: "600", cursor: "pointer", width: "100%", transition: "all 0.2s ease", marginTop: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}
            >
